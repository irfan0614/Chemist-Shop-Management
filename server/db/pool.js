...
// In-Memory store fallback if database server is temporarily offline
const memStore = {
  settings: {
    id: 1,
    ...
    email: 'contact@apollochemist.in',
  ...
  users: [
    ...
    },
    {
      ...
      full_name: 'Rohit Verma (Lead Pharmacist)',
    ...
    },
    {
      ...
      full_name: 'Priya Patel (Billing Cashier)',
